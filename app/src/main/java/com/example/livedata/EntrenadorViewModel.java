            ...
            public LiveData<Integer> apply(String orden) {
                ...
                if(!ejercicio.equals(ejercicioAnterior)){
                    ...
                    switch (ejercicio) {
                        case "EJERCICIO1":
                        default:
                            imagen = R.drawable.f1intro;
                            break;
                        case "EJERCICIO2":
                            imagen = R.drawable.mercedes;
                            break;
                        case "EJERCICIO3":
                            imagen = R.drawable.hamilton;
                            break;
                        case "EJERCICIO4":
                            imagen = R.drawable.botas;
                            break;
                        case "EJERCICIO5":
                            imagen = R.drawable.redbull;
                            break;
                        case "EJERCICIO6":
                            imagen = R.drawable.verstappen;
                            break;
                        case "EJERCICIO7":
                            imagen = R.drawable.checo;
                            break;
                        case "EJERCICIO8":
                            imagen = R.drawable.mcclaren;
                            break;
                        case "EJERCICIO9":
                            imagen = R.drawable.norris;
                            break;
                        case "EJERCICIO10":
                            imagen = R.drawable.ricciardo;
                            break;
                        case "EJERCICIO11":
                            imagen = R.drawable.ferrari;
                            break;
                        case "EJERCICIO12":
                            imagen = R.drawable.carlos;
                            break;
                        case "EJERCICIO13":
                            imagen = R.drawable.leclerc;
                            break;
                        case "EJERCICIO14":
                            imagen = R.drawable.alpine;
                            break;
                        case "EJERCICIO15":
                            imagen = R.drawable.alonso;
                            break;
